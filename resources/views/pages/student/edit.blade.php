    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <div>
                ...
                <div class="text-sm text-gray-500">Halaman untuk mengedit Data Student</div>
            </div>
            <div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('student.update', $student->id) }}" method="POST" class="max-w-sm mx-auto">
                        @csrf
                        @method('PUT')
                        <div class="mb-5">
                            <div class="mt-5">
                                ...
                                <input type="text" name="nip" value="{{ old('nip', $student->nip) }}"
                            ...
                            <div class="mt-5">
                                <label for="class_id" class="block mb-2 text-sm font-medium text-gray-900">Class Number</label>
