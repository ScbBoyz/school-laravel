    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <div>
                ...
                <div class="text-sm text-gray-500">Halaman untuk menambahkan Data Classes</div>
            </div>
            <div>
                        ...
                        <div class="mb-5">
                            <div class="mt-5">
                                <label for="class_number"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Class Number</label>
